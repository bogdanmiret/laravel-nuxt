    ...
    <v-dialog v-model="deleteDialog" max-width="290">
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn @click="deleteDialogDeleteEmail" :loading="deleteDialogLoadingBtn" color="error" text>
            Да
          </v-btn>
        </v-card-actions>
      </v-card>
      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <v-layout justify-start>
            ...
            <v-tooltip bottom>
              <v-btn slot="activator" color="primary" class="mt-3" text icon>
                <v-icon>info</v-icon>
              </v-btn>
        ...
        <v-card-actions>
          ...
          <v-btn color="blue darken-1" @click.native="createDialogSaveEmail" :loading="createDialogLoadingBtn" :disabled="!!this.errors.items.length" text>
            Сохранить
          </v-btn>
        </v-card-actions>
      </v-card>
