                ...
                <form @submit.prevent="submit" autocomplete="on">
                    ...
                    >
                        ...
                        <v-date-picker v-model="form.birthday" :locale="locale" scrollable>
                            <v-spacer></v-spacer>
                            <v-btn text color="primary" @click="modalBirthday = false">Отмена</v-btn>
                            <v-btn text color="primary" @click="$refs.dialog.save(form.birthday)">Ок</v-btn>
                        </v-date-picker>
                    </v-dialog>
    ...
    export default {
        ...
        data() {
            ...
            formDefault = {
                ...
                country,
                timezone,
                birthday: birthday ? this.$dayjs(birthday) : null
            }

            return {
                form: {...formDefault},
                formLocalizedAttributes: null,
                modalBirthday: null,
                loading: false,
