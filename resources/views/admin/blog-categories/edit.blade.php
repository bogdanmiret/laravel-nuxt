...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                @if (isset($item))
                    {!! Form::model($item, array('url' => route('admin.blog-categories.update', [ 'id' => $item['id'] ] ), 'method' => 'put')) !!}
                @else
                    {!! Form::open(array('url' => route('admin.blog-categories.store' ), 'method' => 'post')) !!}
                @endif
                <div class="box-body">
                    <div class="tabbable pills">
                        <ul id="blog" class="nav nav-pills ">
